    ...
    <section class="wrapper">
        ...
        <section class="sidebar">
            ...
            <div class="body">
                ...
                <nav class="navlinks">
                    <a href="./goodlist1.php" class="link active">
        ...
        <section class="content">
            ...
            <center>
                <table border="1" cellpadding="2" class="table1">
                    ...
                    <?php
                    $query = mysqli_query($mysqli, "SELECT trackingNum , postService , dateArrived FROM parcel WHERE status = 'collected' AND recipientName='NUR NAJWA' ");
                    ?>
                    <?php if (mysqli_num_rows($query) > 0) { ?>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php
                                    echo "<form method=\"post\" action=\"receives.php\">";
                                    echo "date received :";
                                    echo "<br>";
                                    echo "<input type=\"date\" name=\"dateReceived\">";
                                    echo "<input type =\"submit\" value=\"received\">";
                                    echo "</form>";
                                    ?>
                                </td>
                            </tr>
